function [epochdatapoints,PETH,epaligned] = IntervalPETH_Irregular(datavals,datatimes,int,tbins4norm,sf,plotparams)
...
[align_onset,align_offset,align_norm,onbins,offbins,normbins] = ...
    BinEpochsToOnOffNorm(epochdatapoints, epochdatapointsamptimes, int, sf, tbins4norm, sampoverhangs);

function [epochdatapoints,PETH,epaligned] = IntervalPETH_IrregularSum(datavals,datatimes,int,tbins4norm,sf,plotparams)
...
[align_onset,align_offset,align_norm,onbins,offbins,normbins] = ...
    BinEpochsSumToOnOffNorm(epochdatapoints, epochdatapointsamptimes, int, sf, tbins4norm, sampoverhangs);

...
for a=1:ne
    ...
    on_binned(:,a) = BinEpochsSum(epochdatapoints{a}, epochsamptimes{a}, tonbins);
    off_binned(:,a) = BinEpochsSum(epochdatapoints{a}, epochsamptimes{a}, toffbins);
    norm_binned(:,a) = BinEpochsSum(epochdatapoints{a}, epochsamptimes{a}, tnormbins);
end

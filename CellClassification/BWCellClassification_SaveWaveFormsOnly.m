...
function  BWCellClassification_SaveWaveFormsOnly (basename, cellshanknums, shanks, ESynapseCells, ISynapseCells, basepath)
% 
...
TroughPeakMs = x;
SpikeWidthMs = y;
MeanWaveforms = v2struct(AllWaves,MaxWaves,cellnums,cellshanknums,shanks,basename,TroughPeakMs,SpikeWidthMs);

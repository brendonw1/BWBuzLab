function [ spindles, hv_spindles, normspindles, DetectionParams ] = Detect_spi_bw(num_CH, spi_CH, varargin )
%Spindle Detection
% 
% input: total number of channels in recording, channel for spindle analysis
